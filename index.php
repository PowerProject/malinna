                ...
                <div class="col-md-10">
                    ...
                    <div class="text-center">
                        ...
                        <ul class="nav nav-pills">
                            ...
                            <li><a href="#stones" data-toggle="tab">С камнями</a></li>
                            <li><a href="#themes" data-toggle="tab">Тематические</a></li>
                        ...
                        <div class="tab-content clearfix">
                            <!-- Simple -->
                            <div class="tab-pane in active clearfix" id="simple">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="overflow">
                                        <a class="fancybox" rel="group" href="img/portfolio/portfolio53.jpg"><img
                                                src="img/portfolio/small/portfolio14.jpg" alt="portfolio53"></a>
                                    </div>
                                </div>
                            </div>
                            <!-- Stones -->
                            <div class="tab-pane" id="stones">
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="overflow">
                            ...
                            <div class="tab-pane" id="themes">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-6">
                                    <div class="overflow">
                                        <a class="fancybox" rel="group" href="img/portfolio/portfolio49.jpg"><img
                                                src="img/portfolio/small/portfolio49.jpg" alt="portfolio49"></a>
                                    </div>
                                </div>
                            </div>
                            <!-- Different -->
